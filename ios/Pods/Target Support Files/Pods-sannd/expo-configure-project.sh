...
with_node \
  ...
  --target "/Users/medi/Documents/School/term3/boxofsand/ios/Pods/Target Support Files/Pods-sannd/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-system-ui" "expo-web-browser"
