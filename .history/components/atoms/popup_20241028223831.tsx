      ...
      <Modal animationType="slide" transparent={true} visible={visible} onRequestClose={() => setVisible(false)}>
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Pressable style={[styles.formButton, { marginTop: 15 }]} onPress={() => setVisible(false)}>
              <Text style={styles.title} onPress={() => navigation.navigate('AutofilledScreen')}>Close</Text>
              <ArrowIcon />
            </Pressable>
          </View>
        </View>
