...
export default function LibraryScreen() {
  ...
  const BackIcon = (props) => (
    <Icon name='arrow-circle-left-outline' {...props}
      style={{ width: 30, height: 20, tint: 'white' }}
    />
  );
    ...
    <>
      <SafeAreaView style={styles.homePage}>
        ...
        <Layout style={{ backgroundColor: 'none', paddingLeft: 20, paddingTop: 20, width: 'auto' }}>
          ...
          <View style={{ backgroundColor: 'none', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', alignContent: 'center', paddingRight: 20, paddingTop: 10, }}>
