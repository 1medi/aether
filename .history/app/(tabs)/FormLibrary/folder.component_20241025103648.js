      ...
      <SafeAreaView style={styles.homePage}>
        <ScrollView style={{ marginHorizontal: 5, backgroundColor: 'none' }}>
          ...
          <Input style={{ borderRadius: '20', width: 320}}
            ...
            />
            <FilterIcon
              style={{width: 50, height: 50, margin: 'auto', color:'#08415C', backgroundColor:'white', padding:20, borderRadius: 20, overflow: 'hidden', background: 'transparent',  borderColor: 'white' }}
            />
          </Layout>
