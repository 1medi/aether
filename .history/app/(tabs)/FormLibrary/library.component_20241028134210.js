    ...
    <>
      <SafeAreaView style={styles.homePage}>
        ...
        <Layout style={{ backgroundColor: 'none', paddingLeft: 20, paddingTop: 20, width: 'auto' }}>
          ...
          <View style={{ backgroundColor: 'none', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <Pressable>
              <BackIcon />
            </Pressable>
            <View style={styles.buttons}>
              ...
              <Pressable style={[styles.formButton, { marginLeft: 30 }]} onPress={() => navigation.navigate('')}>
                <Layout style={styles.textContainer}>
                  <View style={styles.viewContainer}>
