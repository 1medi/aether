      ...
      <SafeAreaView style={styles.homePage}>
        <ScrollView style={{ marginHorizontal: 5, backgroundColor: 'none' }}>
          ...
          <Input style={{ borderRadius: '20', width: 300, margin: '20' }}
            ...
            />
            <FilterIcon
              style={{fontSize: '40', width: 40, height: 40,  color:'#08415C', backgroundColor:'white', padding:20, borderRadius: 20, overflow: 'hidden', background: 'transparent',  borderColor: 'white', padding: '30'}}
            />
          </Layout>
