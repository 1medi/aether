      ...
      <Layout style={styles.container} level="1">
        ...
        >
          <LinearGradient
            ...
            start={{ x: 0.5, y: 0 }} // Customize gradient direction
            end={{ x: 0.5, y: 1 }}
          ...
          >
            ...
            style={styles.modalContent}>
              ...
              <Card style={styles.settingCard}>
                <Button appearance="ghost">Account Information</Button>
              ...
              <Button style={{marginBottom:40}} onPress={() => setVisible(false)}>DISMISS</Button>
            </ScrollView>
          </LinearGradient>
        </Modal>
      </Layout>
